...
function deleteTrip(tripId, options) {
    ...
    if (options?.clearActive || !activeTripId || activeTripId === tripId)
        clearActiveTripId();
    writeTrips(trips);
